  ...
  <div className={styles['footer-text']}>Made with ❤️ by Shawn Salis</div>
      ...
      <div className='flex flex-col w-full px-5 items-center gap-4 md:flex-row md:justify-between'>
        ...
        <div className='social flex flex-row gap-8 order-1 md:order-2'>
          <AiFillGithub size="1.5rem" className="hover:text-blue-600 transition-colors" />
          <AiFillLinkedin size="1.5rem" className="hover:text-blue-600 transition-colors" />
          <AiFillInstagram size="1.5rem" className="hover:text-blue-600 transition-colors" />
          <FaXTwitter size="1.5rem" className="hover:text-blue-600 transition-colors" />
        </div>
      </div>
    </div>
  )
